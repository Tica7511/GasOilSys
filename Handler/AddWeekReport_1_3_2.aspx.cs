...
public partial class Handler_AddWeekReport_1_3_2 : System.Web.UI.Page
{
    WeekReport_1_3_2_DB db = new WeekReport_1_3_2_DB();
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            string tank = (string.IsNullOrEmpty(Request["tank"])) ? "" : Request["tank"].ToString().Trim();
            string pipeline = (string.IsNullOrEmpty(Request["pipeline"])) ? "" : Request["pipeline"].ToString().Trim();
            string disaster = (string.IsNullOrEmpty(Request["disaster"])) ? "" : Request["disaster"].ToString().Trim();
            string energy = (string.IsNullOrEmpty(Request["energy"])) ? "" : Request["energy"].ToString().Trim();
            string oil = (string.IsNullOrEmpty(Request["oil"])) ? "" : Request["oil"].ToString().Trim();
