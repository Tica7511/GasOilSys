...
/// <summary>
/// WeekReport_1_3_2_DB 的摘要描述
/// </summary>
public class WeekReport_1_3_2_DB
{
    ...
    string 管線 = string.Empty;
    string 災害救防 = string.Empty;
    string 能源局 = string.Empty;
    string 中油儲運處 = string.Empty;
    ...
    public string _管線 { set { 管線 = value; } }
    public string _災害救防 { set { 災害救防 = value; } }
    public string _能源局 { set { 能源局 = value; } }
    public string _中油儲運處 { set { 中油儲運處 = value; } }
    ...
    public DataTable GetList()
    {
        ...
        sb.Append(@"select ROW_NUMBER() OVER(ORDER BY 預定日期) AS 場次,* from 週報_計劃書1_3_2 where 年度=@年度 and 資料狀態='A' ");
...
");
        ...
        oCmd.Parameters.AddWithValue("@管線", 管線);
        oCmd.Parameters.AddWithValue("@災害救防", 災害救防);
        oCmd.Parameters.AddWithValue("@能源局", 能源局);
        oCmd.Parameters.AddWithValue("@中油儲運處", 中油儲運處);
    ...
    {
        StringBuilder sb = new StringBuilder();
        sb.Append(@"update 週報_計劃書1_3_2 set
            資料狀態=@資料狀態,
            修改者=@修改者,
            修改日期=@修改日期
            where guid=@guid  
