<%@ Page Language="C#" AutoEventWireup="true" CodeFile="edit_OilUnusualRectifier.aspx.cs" Inherits="WebPage_edit_OilUnusualRectifier" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $(document).on("click", "#cancelbtn", function () {
                ...
                if (str)
                    location.href = "OilUnusualRectifier.aspx?cp=" + $.getQueryString("cp");
            });
            ...
            $(document).on("click", "#subbtn", function () {
                ...
                $.ajax({
                    ...
                    url: "../handler/AddOilUnusualRectifier.aspx",
                    data: data,
                    processData: false,
                    contentType: false,
                    cache: false,
		...
		function getData() {
			$.ajax({
				type: "POST",
				async: false, //在沒有返回值之前,不會執行下一步動作
                url: "../Handler/GetOilUnusualRectifier.aspx",
				data: {
					...
					if ($(data).find("Error").length > 0) {
						...
						if ($(data).find("data_item").length > 0) {
                            $(data).find("data_item").each(function (i) {
                                $("#txt1").val($(this).children("異常整流站名稱").text().trim());
                                $("#txt2_1").val(splitYearMonth(0, $(this).children("異常起始日期年月").text().trim()));
                                $("#txt2_2").val(splitYearMonth(1, $(this).children("異常起始日期年月").text().trim()));
                                $("#txt3").val($(this).children("異常狀況").text().trim());
                                $("#txt4").val($(this).children("整流站修復進度").text().trim());
                                $("#txt5").val($(this).children("影響長途管線識別碼").text().trim());
                                $("#txt6_1").val(splitYearMonth(0, $(this).children("預計完成日期").text().trim()));
                                $("#txt6_2").val(splitYearMonth(1, $(this).children("預計完成日期").text().trim()));
                                $("#txt7").val($(this).children("備註").text().trim());
							});
						}
					}
				}
                    ...
                    <div class="row margin20T">
                        ...
                        <div class="col-lg-9 col-md-8 col-sm-7">
                            ...
                            <div class="OchiTrasTable width100 TitleLength09 font-size3">
                                <div class="OchiRow">
                                    <div class="OchiHalf">
                                        <div class="OchiCell OchiTitle IconCe TitleSetWidth">異常整流站名稱</div>
                                        <div class="OchiCell width100"><input type="text" id="txt1" class="inputex width100"></div>
                                    </div><!-- OchiHalf -->
                                    <div class="OchiHalf">
                                        <div class="OchiCell OchiTitle IconCe TitleSetWidth">異常起始日期 年/月</div>
                                ...
                                <div class="OchiRow">
                                    <div class="OchiHalf">
                                        <div class="OchiCell OchiTitle IconCe TitleSetWidth">異常狀況</div>
                                        <div class="OchiCell width100"><input type="text" id="txt3" class="inputex width100"></div>
                                    </div><!-- OchiHalf -->
                                    <div class="OchiHalf">
                                        <div class="OchiCell OchiTitle IconCe TitleSetWidth">整流站修復進度</div>
                                        <div class="OchiCell width100"><select id="txt4" class="inputex width100"></select></div>
                                    </div><!-- OchiHalf -->
                                </div><!-- OchiRow -->
                                <div class="OchiRow">
                                    <div class="OchiHalf">
                                        <div class="OchiCell OchiTitle IconCe TitleSetWidth">影響長途管線識別碼</div>
                                        <div class="OchiCell width100"><select id="txt5" class="inputex width100"></select></div>
                                    </div><!-- OchiHalf -->
                                    <div class="OchiHalf">
                                        <div class="OchiCell OchiTitle IconCe TitleSetWidth">預計完成日期</div>
                                        <div class="OchiCell width100">
