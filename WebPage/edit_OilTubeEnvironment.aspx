<%@ Page Language="C#" AutoEventWireup="true" CodeFile="edit_OilTubeEnvironment.aspx.cs" Inherits="WebPage_edit_OilTubeEnvironment" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $(document).on("click", "#cancelbtn", function () {
                ...
                if (str)
                    location.href = "OilTubeEnvironment.aspx?cp=" + $.getQueryString("cp");
            });
            ...
            $(document).on("click", "#subbtn", function () {
                ...
                $.ajax({
                    ...
                    url: "../handler/AddOilTubeEnvironment.aspx",
                    data: data,
                    processData: false,
                    contentType: false,
                    cache: false,
		...
		function getData() {
			$.ajax({
				type: "POST",
				async: false, //在沒有返回值之前,不會執行下一步動作
                url: "../Handler/GetOilTubeEnvironment.aspx",
				data: {
					...
					if ($(data).find("Error").length > 0) {
						...
						if ($(data).find("data_item").length > 0) {
                            $(data).find("data_item").each(function (i) {
                                ...
                                $("#txt3").val($(this).children("活動斷層敏感區").text().trim());
                                $("#txt4").val($(this).children("土壤液化區").text().trim());
                                $("#txt5").val($(this).children("土石流潛勢區").text().trim());
                                $("#txt6").val($(this).children("淹水潛勢區").text().trim());
                                $("#txt7").val($(this).children("其他").text().trim());
                                $("#txt8").val($(this).children("備註").text().trim());
							});
						}
					}
				}
                    ...
                    <div class="row margin20T">
                        ...
                        <div class="col-lg-9 col-md-8 col-sm-7">
                            ...
                            <div class="OchiTrasTable width100 TitleLength09 font-size3">
                                <div class="OchiRow">
                                    <div class="OchiHalf">
                                        <div class="OchiCell OchiTitle IconCe TitleSetWidth">轄區長途管線編號</br>(公司)</div>
                                ...
                                <div class="OchiRow">
                                    ...
                                    <div class="OchiHalf">
                                        <div class="OchiCell OchiTitle IconCe TitleSetWidth">其他</div>
