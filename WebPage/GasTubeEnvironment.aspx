<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GasTubeEnvironment.aspx.cs" Inherits="WebPage_GasTubeEnvironment" %>
	...
	<script type="text/javascript">
		...
		function getData() {
			$.ajax({
				...
				url: "../Handler/GetGasTubeEnvironment.aspx",
				data: {
					...
					if ($(data).find("Error").length > 0) {
						...
						if ($(data).find("data_item").length > 0) {
							$(data).find("data_item").each(function (i) {
								...
								tabstr += '<td nowrap="nowrap">' + $(this).children("轄區長途管線編號名稱公司").text().trim() + '</td>';
											...
											<table id="tablist" width="100%" border="0" cellspacing="0" cellpadding="0">
												<thead>
													<tr>
														...
														<th nowrap>轄區長途管線編號/名稱 <br>(公司)</th>
														<th nowrap>活動斷層敏感區 <br>1.有 <br>2.無 </th>
														<th nowrap>土壤液化區 <br>1.有 <br>2.無 </th>
														<th nowrap>土石流 <br>潛勢區 <br>1.有 <br>2.無 </th>
