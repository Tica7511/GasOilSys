<%@ Page Language="C#" AutoEventWireup="true" CodeFile="edit_OilTubeCheck.aspx.cs" Inherits="WebPage_edit_OilTubeCheck" %>
        ...
        $(document).ready(function () {
            ...
            $(document).on("click", "#subbtn", function () {
                ...
                $.ajax({
                    ...
                    url: "../handler/AddOilTubeCheckUnusual.aspx",
                    data: data,
                    processData: false,
                    contentType: false,
                    cache: false,
					...
					if ($(data).find("Error").length > 0) {
						...
						if ($(data).find("data_item").length > 0) {
                            $(data).find("data_item").each(function (i) {
                                $("#txt1").val($(this).children("管線巡檢情形").text().trim());
                                $("#txt2").val($(this).children("前兩年	").text().trim());
                                $("#txt3").val($(this).children("前一年	").text().trim());
							});
						}
					}
				}
                    ...
                    <div class="row margin20T">
                        ...
                        <div class="col-lg-9 col-md-8 col-sm-7">
                            ...
                            <div class="OchiTrasTable width100 TitleLength09 font-size3">
                                <div class="OchiRow">
                                    <div class="OchiCell OchiTitle IconCe TitleSetWidth">管線巡檢情形</div>
                                    <div class="OchiCell width100"><textarea rows="5" cols="" id="txt1" class="inputex width100"></textarea></div>
                                </div><!-- OchiRow -->
                                <div class="OchiRow">
                                    <div class="OchiHalf">
                                        <div class="OchiCell OchiTitle IconCe TitleSetWidth">前二年</div>
                                        <div class="OchiCell width100"><input type="number" min="0" id="txt2" class="inputex width100"></div>
                                    </div><!-- OchiHalf -->
                                </div><!-- OchiRow -->
                                <div class="OchiRow">
                                    <div class="OchiHalf">
                                        <div class="OchiCell OchiTitle IconCe TitleSetWidth">前一年</div>
                                        <div class="OchiCell width100"><input type="number" min="0" id="txt3" class="inputex width100"></div>
                                    </div><!-- OchiHalf -->
                                </div>
                            </div><!-- OchiTrasTable -->
                        </div><!-- col -->
