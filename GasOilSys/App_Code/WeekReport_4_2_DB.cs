...
/// <summary>
/// WeekReport_4_2_DB 的摘要描述
/// </summary>
public class WeekReport_4_2_DB
{
    ...
    public DataTable GetList()
    {
        ...
        sb.Append(@"select ROW_NUMBER() OVER(ORDER BY 預定日期) AS 場次,* from 週報_計劃書4_2 where 年度=@年度 and 資料狀態='A' ");
...
");
    ...
    {
        StringBuilder sb = new StringBuilder();
        sb.Append(@"update 週報_計劃書4_2 set
            資料狀態=@資料狀態,
            修改者=@修改者,
            修改日期=@修改日期
            where guid=@guid  
