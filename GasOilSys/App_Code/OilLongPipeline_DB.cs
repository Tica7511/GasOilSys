...
/// <summary>
/// OilLongPipeline_DB 的摘要描述
/// </summary>
public class OilLongPipeline_DB
{
    ...
    public DataTable GetList()
    {
        ...
        sb.Append(@"select * from 石油_長途管線路徑圖 where 資料狀態='A' and 業者guid=@業者guid ");
...
select DISTINCT 年度 into #tmp from 石油_長途管線路徑圖
...
if(@yearCount > 0)
    ...
    public DataTable GetData()
    {
        ...
        sb.Append(@"select * from 石油_長途管線路徑圖 where guid=@guid and 資料狀態='A' ");
...
select @Ncount=count(*) from 石油_長途管線路徑圖 where 業者guid=@業者guid and 年度=@年度

if(@Ncount > 0)
    begin
        update 石油_長途管線路徑圖 set
        內容=@內容,
        修改者=@修改者,
        修改日期=@修改日期 
