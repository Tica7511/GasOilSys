...
public partial class Handler_AddOilButtonChange : System.Web.UI.Page
{
    OilButtonChange_DB odb = new OilButtonChange_DB();
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            odb._更換日期 = Server.UrlDecode(txt2);
            odb._更換面積 = Server.UrlDecode(txt3);
            odb._更換原因 = Server.UrlDecode(txt4);
