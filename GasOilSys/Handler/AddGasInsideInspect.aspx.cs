...
public partial class Handler_AddGasInsideInspect : System.Web.UI.Page
{
    GasInsideInspect_DB gdb = new GasInsideInspect_DB();
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            gdb._日期 = Server.UrlDecode(txt1);
            gdb._執行單位 = Server.UrlDecode(txt2);
            gdb._稽核範圍 = Server.UrlDecode(txt3);
            gdb._缺失改善執行狀況 = Server.UrlDecode(txt4);
            gdb._佐證資料 = Server.UrlDecode(txt5);
            ...
            for (int i = 0; i < uploadFiles.Count; i++)
            {
                ...
                {
                    string UpLoadPath = ConfigurationManager.AppSettings["UploadFileRootDir"] + "Gas_Upload\\pipeinspect\\";
