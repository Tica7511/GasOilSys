...
public partial class Handler_AddGasCheckSmartTubeCleaner : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            gdb._最近一次執行年月 = (string.IsNullOrEmpty(txt3_1) && string.IsNullOrEmpty(txt3_2)) ? "" :Server.UrlDecode(txt3_1) + "/" + Server.UrlDecode(txt3_2);
            gdb._報告產出年月 = (string.IsNullOrEmpty(txt4_1) && string.IsNullOrEmpty(txt4_2)) ? "" : Server.UrlDecode(txt4_1) + "/" + Server.UrlDecode(txt4_2);
            ...
            for (int i = 0; i < uploadFiles.Count; i++)
            {
                ...
                {
                    string UpLoadPath = ConfigurationManager.AppSettings["UploadFileRootDir"] + "Gas_Upload\\ILI\\";
