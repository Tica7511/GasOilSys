...
public partial class Handler_AddGasStorageTankInfoEvaluation : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            gdb._儲氣設備 = Server.UrlDecode(txt1);
            gdb._查核項目 = Server.UrlDecode(txt2);
            gdb._業者填寫 = Server.UrlDecode(txt3);
            gdb._佐證資料 = Server.UrlDecode(txt4);
            ...
            if (Server.UrlDecode(mode) == "new")
            {
                ...
                gdb.InsertData3(oConn, myTrans);
            }
            else
            {
                gdb._guid = guid;
                gdb.UpdateData3(oConn, myTrans);
            }
