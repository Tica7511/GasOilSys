...
public partial class Handler_AddGasStationAboutDistribution : System.Web.UI.Page
{
    GasStationAboutDistribution_DB gdb = new GasStationAboutDistribution_DB();
    protected void Page_Load(object sender, EventArgs e)
    {
        ///-----------------------------------------------------
        ///功    能: 新增/修改 場站概況分佈圖 圖片儲存
        ///說    明:
        /// * Request["cp"]: 業者guid
        /// * Request["guid"]: guid
        /// * Request["year"]: 年度
        ...
        try
        {
            ...
            gdb._內容 = Server.UrlDecode(nContent);
