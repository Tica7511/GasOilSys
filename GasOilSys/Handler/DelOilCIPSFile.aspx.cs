...
public partial class Handler_DelOilCIPSFile : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (dt.Rows.Count > 0)
            {
                FileInfo fi = new FileInfo(UpLoadPath + "Oil_Upload\\CIPS\\" + dt.Rows[0]["新檔名"].ToString().Trim() + dt.Rows[0]["附檔名"].ToString().Trim());
                if (fi.Exists)
                {
