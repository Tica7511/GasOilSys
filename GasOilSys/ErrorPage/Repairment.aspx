<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Repairment.aspx.cs" Inherits="ErrorPage_Repairment" %>
<!DOCTYPE html>
			...
			<div class="loginblock">
				...
				<div class="padding10ALL">
					<div class="OchiFixTable width100 TitleLength03 font-size3 margin10T">
						<div class="OchiRow">
							<span class="font-size5 font-shadowA font-bold" style="color:red">系統維護中，請稍待片刻，謝謝您。</span><br />
						</div><!-- OchiRow -->
						<div class="OchiRow">
							<span class="font-size4 font-shadowA font-bold" style="color:red"></span><br />
						</div><!-- OchiRow -->
						<div class="OchiRow">
							<span class="font-size4 font-shadowA font-bold" style="color:red"></span><br />                           
						</div><!-- OchiRow -->   
                        <div class="OchiRow">
							<span class="font-size4 font-shadowA font-bold" style="color:red"></span>                           
						</div><!-- OchiRow -->
					</div><!-- OchiFixTable -->
				</div>
			</div>
