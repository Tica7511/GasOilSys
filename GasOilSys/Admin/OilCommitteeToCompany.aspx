<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OilCommitteeToCompany.aspx.cs" Inherits="Admin_OilCommitteeToCompany" %>
	...
	<script type="text/javascript">
        $(document).ready(function () {
            ...
            $(document).on("click", "#subbtn", function () {
				...
				$.ajax({
					...
					url: "BackEnd/AddOilCommittee.aspx",
					data: {
            ...
            $(document).on("click", "a[name='delbtn']", function () {
                if (confirm("確定刪除?")) {
                    $.ajax({
                        type: "POST",
                        async: false, //在沒有返回值之前,不會執行下一步動作
                        url: "BackEnd/DelOilCommittee.aspx",
                        data: {
                            year: getTaiwanDate(),
                            cpguid: $("#CGguid").val(),
                            cguid: $(this).attr("aid")
        ...
        function getCommittee(year) {
			$.ajax({
				type: "POST",
				async: false, //在沒有返回值之前,不會執行下一步動作
                url: "BackEnd/GetOilCommitteeList.aspx",
                data: {
                    type: "list",
                    cid: $("#CGguid").val(),
                    year: year,
