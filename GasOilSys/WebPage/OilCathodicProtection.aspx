...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#exportbtn").attr("href", "../Oil_EXPORTEXCEL.aspx?cpid=" + $.getQueryString("cp") + "&year=" + getTaiwanDate() + "&category=cathodicprotection");

            //選擇年份
            $(document).on("change", "#sellist", function () {
                getData($("#sellist option:selected").val());
                $("#exportbtn").attr("href", "../Oil_EXPORTEXCEL.aspx?cpid=" + $.getQueryString("cp") + "&year=" + $("#sellist option:selected").val() + "&category=cathodicprotection");
            });
            ...
            $(document).on("click", "#importSubbtn", function () {
                if (confirm('請確認上傳的檔案內資料格式是否與範例檔案相同?')) {
                    ...
                    data.append("category", "cathodicprotection");
                    ...
                    <div class="row margin20T">
                        ...
                        <div class="col-lg-9 col-md-8 col-sm-7">
                            ...
                            <div class="margin5TB font-size2">
                                填表說明：<br />
                                (1) 若「設置」欄位填寫「有」，請於「整流站名稱」填寫負責該儲槽陰極防蝕系統之整流站名稱。<br>
                                (2) 合格標準：請依據該管線檢測報告判定結果時，所引用之標準，請填入相對應之數字，<br>
                                1. 通電電位< -850mVCSE  2.極化電位< -850mVCSE  3.極化量>100mV 4.其他<br>
                                (3) 設置長效型性參考電極種類：若有設置長效型參考電極，請依種類選填「鋅」或「飽和硫酸銅」；若無設置長效型參考電極，請填3。<br>
                                (4) 陽極地床種類：請依實際設置情形，選填「深井」或「淺井」。
      ...
      <div class="OchiTrasTable width100 TitleLength08 font-size3">
          <div class="OchiRow">
              ...
              <div class="OchiCell width100">
                  <i class="fa fa-file-excel-o IconCc" aria-hidden="true"></i><a href="../doc/import/Oil/石油_陰極防蝕系統.xls">下載</a>
              </div>
          </div><!-- OchiRow -->
          <div class="OchiRow">
