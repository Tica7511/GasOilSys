<%@ Page Title="" Language="C#" MasterPageFile="~/WebPage/MasterPageWeek.master" AutoEventWireup="true" CodeFile="SeasonView.aspx.cs" Inherits="WebPage_SeasonView" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    ...
    <script type="text/javascript">
        ...
        function getSeason() {
            ...
            $("#exportbtn").attr("href", "../Handler/ExportAsposeReport3.aspx?Year=" + (parseInt($.getQueryString("year")) + 1911).toString() + 
                "&Season=" + $.getQueryString("season"));
        }
    </script>
</asp:Content>
