<%@ Page Language="C#" AutoEventWireup="true" CodeFile="edit_GasTubeCheck_Unusual.aspx.cs" Inherits="WebPage_edit_GasTubeCheck_Unususal" %>
        ...
        $(document).ready(function () {
            ...
            $(document).on("click", "#subbtn", function () {
                ...
                $.ajax({
                    ...
                    url: "../handler/AddGasTubeCheckUnusual.aspx",
                    data: data,
                    processData: false,
                    contentType: false,
                    cache: false,
                    ...
                    <div class="row margin20T">
						...
						<div class="col-lg-9 col-md-8 col-sm-7">
                            ...
                            <div class="OchiTrasTable width100 TitleLength09 font-size3">
                                ...
                                <div class="OchiRow">
                                    <div class="OchiHalf">
                                        <div class="OchiCell OchiTitle IconCe TitleSetWidth">前兩年</div>
