<%@ Page Language="C#" AutoEventWireup="true" CodeFile="edit_GasStorageTankInfo_Evaluation.aspx.cs" Inherits="WebPage_edit_GasStorageTankInfo_Evaluation" %>
        ...
        $(document).ready(function () {
            ...
            $(document).on("click", "#subbtn", function () {
                ...
                $.ajax({
                    ...
                    url: "../handler/AddGasStorageTankInfoEvaluation.aspx",
                    data: data,
                    processData: false,
                    contentType: false,
                    cache: false,
                    ...
                    if ($(data).find("Error").length > 0) {
                        ...
                        if ($(data).find("data_item").length > 0) {
                            $(data).find("data_item").each(function (i) {
                                $("#txt1").val($(this).children("儲氣設備").text().trim());
                                $("#txt2").val($(this).children("查核項目").text().trim());
                                $("#txt3").val($(this).children("業者填寫").text().trim());
                                $("#txt4").val($(this).children("佐證資料").text().trim());
                            });
                        }
                    }
                }
                    ...
                    <div class="row margin20T">
						...
						<div class="col-lg-9 col-md-8 col-sm-7">
                            ...
                            <div class="OchiTrasTable width100 TitleLength09 font-size3">
                                <div class="OchiRow">
                                    <div class="OchiHalf">
                                        <div class="OchiCell OchiTitle IconCe TitleSetWidth">儲氣設備</div>
                                        <div class="OchiCell width100"><input type="text" id="txt1" class="inputex width100"></div>
                                    </div><!-- OchiHalf -->
                                    <div class="OchiHalf">
                                        <div class="OchiCell OchiTitle IconCe TitleSetWidth">查核項目</div>
                                        <div class="OchiCell width100"><input type="text" id="txt2" class="inputex width100"></div>
                                    </div><!-- OchiHalf -->
                                </div><!-- OchiRow -->
                                <div class="OchiRow">
                                    <div class="OchiHalf">
                                        <div class="OchiCell OchiTitle IconCe TitleSetWidth">業者填寫</div>
                                ...
                                <div class="OchiRow">
                                    <div class="OchiCell OchiTitle IconCe TitleSetWidth">佐證資料</div>
                                    <div class="OchiCell width100"><textarea id="txt4" rows="5" cols="" class="inputex width99" ></textarea></div>
                                </div>
                            </div><!-- OchiTrasTable -->
                        </div><!-- col -->
                    </div><!-- row -->
