<%@ Page Language="C#" AutoEventWireup="true" CodeFile="edit_OilInternalAudit.aspx.cs" Inherits="WebPage_edit_OilInternalAudit" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $(document).on("click", "#cancelbtn", function () {
                ...
                if (str)
                    location.href = "OilInternalAudit.aspx?cp=" + $.getQueryString("cp");
            });
            ...
            $(document).on("click", "#subbtn", function () {
                ...
                $.ajax({
                    ...
                    url: "../handler/AddOilInternalAudit.aspx",
                    data: data,
                    processData: false,
                    contentType: false,
                    cache: false,
					...
					if ($(data).find("Error").length > 0) {
                        ...
                        if ($(data).find("data_item").length > 0) {
                            $(data).find("data_item").each(function (i) {
                                $("#txt1").val(getDate($(this).children("內部稽核日期").text().trim()));
                                ...
                                if ($(this).children("佐證資料檔名").text().trim() != '') {
                                    ...
                                    if (extension == '.jpg' || extension == '.jpeg' || extension == '.png' || extension == '.gif') {
                                        filestr += '<img width="300px" height="300px" name="imgfile" src="../DOWNLOAD.aspx?category=Oil&type=storageinspect&v=' +
                                        ...
                                        filestr += '<a name="afile" href="../DOWNLOAD.aspx?category=Oil&type=storageinspect&v=' +
