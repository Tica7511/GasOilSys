<%@ Page Language="C#" AutoEventWireup="true" CodeFile="edit_GasControl_Stress.aspx.cs" Inherits="WebPage_edit_GasControl_Stress" %>
	...
	<script type="text/javascript">
        $(document).ready(function () {
            ...
            $(document).on("click", "#subbtn", function () {
                ...
                data.append("type", encodeURIComponent('02'));
                ...
                $.ajax({
                    ...
                    url: "../handler/AddGasControlFile.aspx",
                    data: data,
                    processData: false,
                    contentType: false,
                    cache: false,
