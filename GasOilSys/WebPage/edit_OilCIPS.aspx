<%@ Page Language="C#" AutoEventWireup="true" CodeFile="edit_OilCIPS.aspx.cs" Inherits="WebPage_edit_OilCIPS" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $(document).on("click", "#cancelbtn", function () {
                ...
                if (str)
                    location.href = "OilCIPS.aspx?cp=" + $.getQueryString("cp");
            });
                    ...
                    if ($(data).find("Error").length > 0) {
                        ...
                        if ($(data).find("data_item").length > 0) {
                            $(data).find("data_item").each(function (i) {
                                ...
                                $("#txt6").val($(this).children("合格標準").text().trim());
                    ...
                    <div class="row margin20T">
                        ...
                        <div class="col-lg-9 col-md-8 col-sm-7">
                            ...
                            <div class="OchiTrasTable width100 TitleLength09 font-size3">
                                ...
                                <div class="OchiRow">
                                    <div class="OchiHalf">
                                        <div class="OchiCell OchiTitle IconCe TitleSetWidth">折線圖 年/月</div>
                                        <div class="OchiCell width100">
