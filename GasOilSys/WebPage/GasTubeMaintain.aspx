<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GasTubeMaintain.aspx.cs" Inherits="WebPage_GasTubeMaintain" %>
...
<head>
	...
	<script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#exportbtn").attr("href", "../Gas_EXPORTEXCEL.aspx?cpid=" + $.getQueryString("cp") + "&year=" + getTaiwanDate() + "&category=tubemaintain");

            //選擇年份
            $(document).on("change", "#sellist", function () {
                getData($("#sellist option:selected").val());
                $("#exportbtn").attr("href", "../Gas_EXPORTEXCEL.aspx?cpid=" + $.getQueryString("cp") + "&year=" + $("#sellist option:selected").val() + "&category=tubemaintain");
            });
					...
					if ($(data).find("Error").length > 0) {
						...
						if ($(data).find("data_item").length > 0) {
							$(data).find("data_item").each(function (i) {
								...
								tabstr += '<td nowrap="nowrap">' + $(this).children("前一年度").text().trim() + '</td>';
                                ...
                                <table id="tablist" width="100%" border="0" cellspacing="0" cellpadding="0">
									<thead>
										<tr>
											...
											<th nowrap>前一年度 <br>1.維修 <br>2.換管 <br>3.遷管 <br>4.開挖 </th>
