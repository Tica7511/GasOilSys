<%@ Page Language="C#" AutoEventWireup="true" CodeFile="edit_GasTubeMaintain.aspx.cs" Inherits="WebPage_edit_GasTubeMaintain" %>
	...
	<script type="text/javascript">
        $(document).ready(function () {
            ...
            $(document).on("click", "#cancelbtn", function () {
                ...
                if (str)
                    location.href = "GasTubeMaintain.aspx?cp=" + $.getQueryString("cp");
            });
            ...
            $(document).on("click", "#subbtn", function () {
                ...
                $.ajax({
                    ...
                    url: "../handler/AddGasTubeMaintain.aspx",
                    data: data,
                    processData: false,
                    contentType: false,
                    cache: false,
                    ...
                    if ($(data).find("Error").length > 0) {
                        ...
                        if ($(data).find("data_item").length > 0) {
                            $(data).find("data_item").each(function (i) {
                                ...
                                $("#txt2").val($(this).children("前一年度").text().trim());
                                $("#txt3").val($(this).children("長度").text().trim());
                                $("#txt4").val($(this).children("管線位置").text().trim());
