					...
					if ($(data).find("Error").length > 0) {
						...
						if ($(data).find("data_item").length > 0) {
							$(data).find("data_item").each(function (i) {
								tabstr += '<tr>';
								tabstr += '<td nowrap="nowrap">' + $(this).children("事故日期").text().trim() + '</td>';
								tabstr += '<td nowrap="nowrap">' + $(this).children("事故名稱").text().trim() + '</td>';
								tabstr += '<td nowrap="nowrap">' + $(this).children("事故原因").text().trim() + '</td>';
								tabstr += '<td nowrap="nowrap">' + $(this).children("改善作為").text().trim() + '</td>';
								tabstr += '</tr>';
							});
						}
						else
