...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#exportbtn").attr("href", "../Oil_EXPORTEXCEL.aspx?cpid=" + $.getQueryString("cp") + "&year=" + getTaiwanDate() + "&category=cips");

            //選擇年份
            $(document).on("change", "#sellist", function () {
                getData($("#sellist option:selected").val());
                $("#exportbtn").attr("href", "../Oil_EXPORTEXCEL.aspx?cpid=" + $.getQueryString("cp") + "&year=" + $("#sellist option:selected").val() + "&category=cips");
            });
                    ...
                    <div class="row margin20T">
                        ...
                        <div class="col-lg-9 col-md-8 col-sm-7">
                            ...
                            <div class="margin5TB font-size2">
                                ...
                                (3) 合格標準：請依據該管線檢測報告判定結果時，所引用之標準，請填入相對應之數字， 1. 通電電位< -850mVCSE  2.極化電位< -850mVCSE  3.極化量>100mV  4.其他<br>
                                (4) 立即改善、排程改善<br>
                                A.數量：依據公司之檢測合格標準，所判定立即改善(排程改善)的點數。<br>
                                B.改善完成數量：依據公司之檢測合格標準，須立即改善(排程改善)且已完成改善之點數。<br>
                                (5) 需監控點數量：依據公司之檢測合格標準，須監控之數量。<br>
                                (6) 異常點尚未改善之座標：僅須填寫立即改善及排程改善尚未改善完成點之座標，若2點以上，請逐列列出，或以附件方式上傳(雲端平台)。異常點座標可以是檢測報告電子檔所附之座標、若報告無提供座標，請於現場利用手機定位。(座標格式TWI97)<br>
                                (7) 備註：若檢測時之管線數量2條以上(含)，請以同一代號註明同一管束，如：以A、B…區別。
                            </div>
