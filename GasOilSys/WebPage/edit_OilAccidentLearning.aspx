<%@ Page Language="C#" AutoEventWireup="true" CodeFile="edit_OilAccidentLearning.aspx.cs" Inherits="WebPage_edit_OilAccidentLearning" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $(document).on("click", "#cancelbtn", function () {
                ...
                if (str)
                    location.href = "OilAccidentLearning.aspx?cp=" + $.getQueryString("cp");
            });
            ...
            $(document).on("click", "#subbtn", function () {
                ...
                $.ajax({
                    ...
                    url: "../handler/AddOilAccidentLearning.aspx",
                    data: data,
                    processData: false,
                    contentType: false,
                    cache: false,
