<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PublicGasDoorRecord.aspx.cs" Inherits="WebPage_PublicGasDoorRecord" %>
...
<head>
	...
	<title>公用天然氣事業輸儲設備現場查核系統</title><!--#include file="Head_Include.html"-->
	<script type="text/javascript">
		$(document).ready(function () {
            getYearList();
            $("#sellist").val(getTaiwanDate());
            getData(getTaiwanDate());
            $("#exportbtn").attr("href", "../Gas_EXPORTEXCEL.aspx?cpid=" + $.getQueryString("cp") + "&year=" + getTaiwanDate() + "&category=unusualrectifier");

            //選擇年份
            $(document).on("change", "#sellist", function () {
                getData($("#sellist option:selected").val());
                $("#exportbtn").attr("href", "../Gas_EXPORTEXCEL.aspx?cpid=" + $.getQueryString("cp") + "&year=" + $("#sellist option:selected").val() + "&category=unusualrectifier");
            });

            //新增按鈕
            $(document).on("click", "#newbtn", function () {
                location.href = "edit_GasUnusualRectifier.aspx?cp=" + $.getQueryString("cp");
            });
            ...
            $(document).on("click", "a[name='delbtn']", function () {
                if (confirm("確定刪除?")) {
                    $.ajax({
                        ...
                        url: "../handler/DelGasUnusualRectifier.aspx",
                        data: {
                            guid: $(this).attr("aid"),
                        },
                        error: function (xhr) {
					...
					<div id="ContentWrapper">
						<div class="container margin15T">
							<div class="padding10ALL">
								<div class="filetitlewrapper"><!--#include file="PublicGasBreadTitle.html"--></div>

								<div class="row margin20T">
									<div class="col-lg-3 col-md-4 col-sm-5">
										<div id="navmenuV"><!--#include file="PublicGasLeftMenu.html"--></div>
									</div>
											...
											<table id="tablist" width="100%" border="0" cellspacing="0" cellpadding="0">
												<thead>
													<tr>
														...
														<th rowspan="3">壓力別</th>
														<th rowspan="3">口徑(m/m)</th>
														<th rowspan="3">隸屬管線</th>
														<th rowspan="3">檢查日期</th>
														<th nowrap colspan="7">檢查結果</th>
                                                        <th rowspan="3">防滑蓋改善</th>
                                                        <th rowspan="3">備註</th>
                                                        <th rowspan="3" id="th_edit">功能 </th>
                                                    </tr>
                                                    <tr>
														<th nowrap colspan="3">漏氣檢測</th>
														<th rowspan="3">抽水(公升)</th>
														<th rowspan="3">閥門試轉<br />(22-45)</th>
														<th rowspan="3">油漆</th>
														<th rowspan="3">汙泥</th>
													</tr>
                                                    <tr>
