					...
					if ($(data).find("Error").length > 0) {
						...
						if ($(data).find("data_item").length > 0) {
							$(data).find("data_item").each(function (i) {
								...
								tabstr += '<td>' + $(this).children("用戶名稱").text().trim() + '</td>';

								var ckdate01, ckdate02;
								ckdate01 = ($(this).children("檢查期限是否符合").text().trim() == "01") ? '<input type="radio" disabled="disabled" value="01" checked="checked" />' : '<input type="radio" disabled="disabled" value="01" />';
								ckdate02 = ($(this).children("檢查期限是否符合").text().trim() == "02") ? '<input type="radio" disabled="disabled" value="02" checked="checked" />' : '<input type="radio" disabled="disabled" value="02" />';
								tabstr += '<td>' + ckdate01 + '符合</td>';
								tabstr += '<td>' + ckdate02 + '不符合</td>';

								var ckresult01, ckresult02,ckresult03;
								ckresult01 = ($(this).children("檢查結果是否符合").text().trim() == "01") ? '<input type="radio" disabled="disabled" value="01" checked="checked" />' : '<input type="radio" disabled="disabled" value="01" />';
								ckresult02 = ($(this).children("檢查結果是否符合").text().trim() == "02") ? '<input type="radio" disabled="disabled" value="02" checked="checked" />' : '<input type="radio" disabled="disabled" value="02" />';
								ckresult03 = ($(this).children("檢查結果是否符合").text().trim() == "03") ? '<input type="radio" disabled="disabled" value="03" checked="checked" />' : '<input type="radio" disabled="disabled" value="03" />';
                ...
                <div class="padding10ALL">
                    ...
                    <div class="row margin20T">
                        ...
                        <div class="col-lg-9 col-md-8 col-sm-7">
                            ...
                            <div class="font-size3"><input type="checkbox" id="usercheck" disabled="disabled"> 用戶管線定期檢查：<input type="checkbox" id="outsidecheck" disabled="disabled"> 委外檢查</div>
