<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PublicGasDetail.aspx.cs" Inherits="WebPage_PublicGasDetail" %>
                                    ...
                                    <div class="BoxBorderDa BoxRadiusB padding5ALL">
                                        ...
                                        <div class="OchiTrasTable width100 TitleLength08 font-size3">
                                            ...
                                            <div class="OchiRow">
                                                ...
                                                <div class="OchiCell width100"><input type="text" id="cname" value="竹名天然氣股份有限公司" class="inputex width99" disabled></div>
                                            </div><!-- OchiRow -->
                                            <div class="OchiRow">
                                                <div class="OchiCell OchiTitle IconCe TitleSetWidth">地址</div>
                                                <div class="OchiCell width100"><input type="text" id="caddr" value="南投縣名間鄉三崙村弓鞋巷7-1號" class="inputex width99" disabled></div>
                                            </div><!-- OchiRow -->
                                            <div class="OchiRow">
                                                <div class="OchiHalf">
