<%@ Page Language="C#" AutoEventWireup="true" CodeFile="edit_OilControl.aspx.cs" Inherits="WebPage_edit_OilControl" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $(document).on("click", "#subbtn", function () {
                ...
                //    msg += "請選擇【高液位警報設定基準】\n";
                //if ($("#txt6").val() == '')
                //    msg += "請選擇【前一年度高液位警報發生頻率】\n";
                //if ($("#txt7").val() == '')
                //    msg += "請選擇【液位異常下降警報設定基準】\n";
                //if ($("#txt8").val() == '')
                ...
                $.ajax({
                    ...
                    url: "../handler/AddOilControlReceiveData.aspx",
                    data: data,
                    processData: false,
                    contentType: false,
                    cache: false,
					...
					if ($(data).find("Error").length > 0) {
						...
						if ($(data).find("data_item").length > 0) {
                            $(data).find("data_item").each(function (i) {
                                ...
                                $("#txt6").val($(this).children("前一年度高液位警報發生頻率").text().trim());
                                $("#txt7").val($(this).children("液位異常下降警報設定基準").text().trim());
                                $("#txt8").val($(this).children("前一年度異常下降警報發生頻率").text().trim());
							});
						}
					}
				}
                    ...
                    <div class="row margin20T">
                        ...
                        <div class="col-lg-9 col-md-8 col-sm-7">
                            ...
                            <div class="OchiTrasTable width100 TitleLength09 font-size3">
                                ...
                                <div class="OchiRow">
                                    <div class="OchiHalf">
                                        <div class="OchiCell OchiTitle IconCe TitleSetWidth">液位監測靈敏度</div>
                                        <div class="OchiCell width100"><input type="number" min="0" id="txt4" class="inputex width50"> mm</div>
                                    </div><!-- OchiHalf -->
                                </div><!-- OchiRow -->
                                <div class="OchiRow">
                                    <div class="OchiHalf">
                                        <div class="OchiCell OchiTitle IconCe TitleSetWidth">高液位警報設定基準</div>
                                        <div class="OchiCell width100"><input type="number" min="0" id="txt5" class="inputex width50"> mm</div>
                                    </div><!-- OchiHalf -->
                                    <div class="OchiHalf">
                                        <div class="OchiCell OchiTitle IconCe TitleSetWidth">前一年度高液位警報</br>發生頻率</div>
                                        <div class="OchiCell width100"><input type="text" id="txt6" class="inputex width80"> 次/年</div>
                                    </div><!-- OchiHalf -->
                                </div><!-- OchiRow -->
                                <div class="OchiRow">
                                    <div class="OchiHalf">
                                        <div class="OchiCell OchiTitle IconCe TitleSetWidth">液位異常下降警報</br>設定基準</div>
                                        <div class="OchiCell width100"><input type="number" min="0" id="txt7" class="inputex width50"> mm</div>
                                    </div><!-- OchiHalf -->
                                    <div class="OchiHalf">
                                        <div class="OchiCell OchiTitle IconCe TitleSetWidth">前一年度異常下降警報發生頻率</div>
                                        <div class="OchiCell width100"><input type="text" id="txt8" class="inputex width80"> 次/年</div>
                                    </div><!-- OchiHalf -->
                                </div><!-- OchiRow -->
                            </div><!-- OchiTrasTable -->
