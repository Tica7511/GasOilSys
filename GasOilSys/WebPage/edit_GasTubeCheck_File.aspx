<%@ Page Language="C#" AutoEventWireup="true" CodeFile="edit_GasTubeCheck_File.aspx.cs" Inherits="WebPage_edit_GasTubeCheckFile" %>
        ...
        $(document).ready(function () {
            ...
            $(document).on("click", "#subbtn", function () {
                ...
                $.ajax({
                    ...
                    url: "../handler/AddGasTubeCheckFile.aspx",
                    data: data,
                    processData: false,
                    contentType: false,
                    cache: false,
                    ...
                    if ($(data).find("Error").length > 0) {
                        ...
                        if ($(data).find("data_item").length > 0) {
                            $(data).find("data_item").each(function (i) {
                                $("#txt1").val($(this).children("依據文件名稱").text().trim());
