<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StatisticsPipeInfo.aspx.cs" Inherits="WebPage_StatisticsPipeInfo" %>
	...
	<script type="text/javascript">
        ...
        function getData(p) {
            $.ajax({
                ...
                url: "../Handler/GetStatisticsPipeInfo.aspx",
                data: {
                    type: "list",
                    ctype: $("#txt1").val(),
                    cpname: $("#txt2").val(),
                    ...
                    if ($(data).find("Error").length > 0) {
                        ...
                        if ($("#txt1").val() == '01') {
                            tabstr += '<table width="100%" border="0" cellspacing="0" cellpadding="0"><thead><tr><th align="center" nowrap="nowrap">長途管線識別碼</th><th align="center" nowrap="nowrap">業者簡稱</th><th align="center" nowrap="nowrap">轄區長途管線名稱<br>(公司)</th>' +
                                ...
                                '<th align="center" nowrap="nowrap">包覆<br>材料</th><th align="center" nowrap="nowrap">轄管長度<br>(公里)</th><th align="center" nowrap="nowrap">內容物</th><th align="center" nowrap="nowrap">八大油品</th>' + 
                                '<th align="center" nowrap="nowrap">緊急遮斷閥<br>(處)</th><th align="center" nowrap="nowrap">建置年</th><th align="center" nowrap="nowrap">設計壓力<br>(Kg/cm<sup>2</sup>)</th>' +
                        ...
                        $("#sp_totalText").html('共' + $("total", data).text() + '條管線');
                    ...
                    <div class="row margin20T">
                        ...
                        <div class="col-lg-9 col-md-8 col-sm-7">
                            <div class="BoxBgWa BoxRadiusA BoxBorderSa padding10ALL margin10T">
                                ...
                                <div class="OchiRow">
                                    <div class="OchiHalf">
                                        <div class="OchiCell OchiTitle IconCe TitleSetWidth">建置年份</div>
                                        <div class="OchiCell width100">
                                            <input id="txt7" type="text" class="width100 inputex" />
                                        </div>
                                    </div><!-- OchiHalf -->
                                    <div class="OchiHalf">
                                        <div class="OchiCell OchiTitle IconCe TitleSetWidth">管徑</div>
                                        <div class="OchiCell width100">
                                            <input id="txt8" type="text" class="width100 inputex" />
                                        </div>
                                    </div><!-- OchiHalf -->
                                </div><!-- OchiRow -->
                                <div id="div_oil" class="OchiRow">
                                    <div class="OchiHalf">
