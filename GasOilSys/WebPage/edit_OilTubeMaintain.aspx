<%@ Page Language="C#" AutoEventWireup="true" CodeFile="edit_OilTubeMaintain.aspx.cs" Inherits="WebPage_edit_OilTubeMaintain" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $(document).on("click", "#cancelbtn", function () {
                ...
                if (str)
                    location.href = "OilTubeMaintain.aspx?cp=" + $.getQueryString("cp");
            });
            ...
            $(document).on("click", "#subbtn", function () {
                ...
                $.ajax({
                    ...
                    url: "../handler/AddOilTubeMaintain.aspx",
                    data: data,
                    processData: false,
                    contentType: false,
                    cache: false,
					...
					if ($(data).find("Error").length > 0) {
						...
						if ($(data).find("data_item").length > 0) {
                            $(data).find("data_item").each(function (i) {
                                ...
                                $("#txt2").val($(this).children("前一年度管線變更性質").text().trim());
                                $("#txt3").val($(this).children("長度").text().trim());
                                $("#txt4").val($(this).children("管段位置").text().trim());
                        ...
                        <div class="col-lg-9 col-md-8 col-sm-7">
                            <div class="twocol">
                                <div class="left font-size4" style="width:50%">
                                    ...
                                    國土資訊系統管線編號 : <select id="txt1" class="width40 inputex" ></select>
                                </div>
                                <div class="right">
                            ...
                            <div class="OchiTrasTable width100 TitleLength09 font-size3">
                                <div class="OchiRow">
                                    ...
                                    <div class="OchiHalf">
                                        ...
                                        <div class="OchiCell width100"><input type="number" min="0" id="txt3" class="inputex width40"> 公尺</div>
                                    </div><!-- OchiHalf -->
                                </div><!-- OchiRow -->
                                <div class="OchiRow">
                                    <div class="OchiHalf">
                                        <div class="OchiCell OchiTitle IconCe TitleSetWidth">管段位置</div>
