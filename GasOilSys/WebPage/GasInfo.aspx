...
<body class="bgG">
                        ...
                        <div class="container margin15T">
                            <div class="padding10ALL">
                                <div class="filetitlewrapper">
                                    <!--#include file="GasBreadTitle.html"-->
                                </div>
                                                    ...
                                                    <div class="OchiTrasTable width100 TitleLength08 font-size3">
                                                        <div class="OchiRow">
                                                            <div class="OchiHalf">
                                                                ...
                                                                <div class="OchiCell width100">
                                                                    <input type="text" id="mainline" class="inputex width80" disabled>
                                                                    公里
                                                                </div>
                                                            </div>
                                                            <!-- OchiHalf -->
                                                            <div class="OchiHalf">
                                                                ...
                                                                <div class="OchiCell width100">
                                                                    <input type="text" id="cycleline" class="inputex width80" disabled>
                                                                    公里
                                                                </div>
                                                            </div>
                                                            <!-- OchiHalf -->
                                                        ...
                                                        <div class="OchiRow">
                                                            <div class="OchiHalf">
                                                                ...
                                                                <div class="OchiCell width100">
                                                                    <input type="text" id="businessline" class="inputex width80" disabled>
                                                                    公里
                                                                </div>
                                                            </div>
                                                            <!-- OchiHalf -->
                                                            <div class="OchiHalf">
                                                                ...
                                                                <div class="OchiCell width100">
                                                                    <input type="text" id="specialline" class="inputex width80" disabled>
                                                                    公里
                                                                </div>
                                                            </div>
                                                            <!-- OchiHalf -->
                                                        ...
                                                        <div class="OchiRow">
                                                            <div class="OchiHalf">
                                                                ...
                                                                <div class="OchiCell width100">
                                                                    <input type="text" id="finishline" class="inputex width80" disabled>
                                                                    公里
                                                                </div>
                                                            </div>
                                                            <!-- OchiHalf -->
                                                            <div class="OchiHalf">
                                                                ...
                                                                <div class="OchiCell width100">
                                                                    <input type="text" id="sealine" class="inputex width80" disabled>
                                                                    公里
                                                                </div>
                                                            </div>
                                                            <!-- OchiHalf -->
                                                        ...
                                                        <div class="OchiRow">
                                                            <div class="OchiHalf">
                                                                ...
                                                                <div class="OchiCell width100">
                                                                    <input type="text" id="LNGline" class="inputex width80" disabled>
                                                                    公里
                                                                </div>
                                                            </div>
                                                            <!-- OchiHalf -->
                                                            <div class="OchiHalf">
                                                                ...
                                                                <div class="OchiCell width100">
                                                                    <input type="text" id="BOGline" class="inputex width80" disabled>
                                                                    公里
                                                                </div>
                                                            </div>
                                                            <!-- OchiHalf -->
                                                        ...
                                                        <div class="OchiRow">
                                                            <div class="OchiHalf">
                                                                ...
                                                                <div class="OchiCell width100">
                                                                    <input type="text" id="NGline" class="inputex width80" disabled>
                                                                    公里
                                                                </div>
                                                            </div>
                                                            <!-- OchiHalf -->
                                                        ...
                                                        <div class="OchiRow">
                                                            ...
                                                            <div class="OchiCell width100">
                                                                <input type="text" id="supplycity" class="inputex width99" disabled>
                                                            </div>
                                                        </div>
                                                        <!-- OchiRow -->
                                                        ...
                                                        <div class="OchiRow">
                                                            ...
                                                            <div class="OchiCell width100">
                                                                <div class="inlineitem">
                                                                    <input type="checkbox" name="supplygas" value="01" disabled="disabled">
                                                                    NG1 進口天然氣與自產天然氣摻配
                                                                </div>
                                                                <div class="inlineitem">
                                                                    <input type="checkbox" name="supplygas" value="02" disabled="disabled">
                                                                    NG1自產天然氣
                                                                </div>
                                                                <div class="inlineitem">
                                                                    <input type="checkbox" name="supplygas" value="03" disabled="disabled">
                                                                    NG2進口天然氣
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="OchiTrasTable width100 TitleLength08 font-size3">
                                                        <div class="OchiRow">
                                                            <div class="OchiHalf">
                                                                ...
                                                                <div class="OchiCell width100">
                                                                    <input type="text" id="ov1" class="inputex width100" disabled>
                                                                </div>
                                                            </div>
                                                            <!-- OchiHalf -->
                                                            <div class="OchiHalf">
                                                                ...
                                                                <div class="OchiCell width100">
                                                                    <input type="text" id="ov2" class="inputex width100" disabled>
                                                                </div>
                                                            </div>
                                                            <!-- OchiHalf -->
                                                        </div>
                                                        ...
                                                        <div class="OchiRow">
                                                            <div class="OchiHalf">
                                                                ...
                                                                <div class="OchiCell width100">
                                                                    <input type="text" id="ov3" class="inputex width100" disabled>
                                                                </div>
                                                            </div>
                                                            <!-- OchiHalf -->
                                                            <div class="OchiHalf">
                                                                ...
                                                                <div class="OchiCell width100">
                                                                    <input type="text" id="ov4" class="inputex width100" disabled>
                                                                </div>
                                                            </div>
                                                            <!-- OchiHalf -->
                                                        </div>
                                                        ...
                                                        <div class="OchiRow">
                                                            <div class="OchiHalf">
                                                                ...
                                                                <div class="OchiCell width100">
                                                                    <input type="text" id="ov5" class="inputex width100" disabled>
                                                                </div>
                                                            </div>
                                                            <!-- OchiHalf -->
                                                            <div class="OchiHalf">
                                                                ...
                                                                <div class="OchiCell width100">
                                                                    <input type="text" id="ov6" class="inputex width100" disabled>
                                                                </div>
                                                            </div>
                                                            <!-- OchiHalf -->
                                                        </div>
                                                        ...
                                                        <div class="OchiRow">
                                                            <div class="OchiHalf">
                                                                ...
                                                                <div class="OchiCell width100">
                                                                    <input type="text" id="ov7" class="inputex width100" disabled>
                                                                </div>
                                                            </div>
                                                            <!-- OchiHalf -->
                                                            <div class="OchiHalf">
                                                                ...
                                                                <div class="OchiCell width100">
                                                                    <input type="text" id="ov8" class="inputex width100" disabled>
                                                                </div>
                                                            </div>
                                                            <!-- OchiHalf -->
                                                        </div>
                                                        ...
                                                        <div class="OchiRow">
                                                            <div class="OchiHalf">
                                                                ...
                                                                <div class="OchiCell width100">
                                                                    <input type="text" id="ov9" class="inputex width100" disabled>
                                                                </div>
                                                            </div>
                                                            <!-- OchiHalf -->
                                                            <div class="OchiHalf">
                                                                ...
                                                                <div class="OchiCell width100">
                                                                    <input type="text" id="ov10" class="inputex width100" disabled>
                                                                </div>
                                                            </div>
                                                            <!-- OchiHalf -->
                                                        </div>
                                                        ...
                                                        <div class="OchiRow">
                                                            <div class="OchiHalf">
                                                                ...
                                                                <div class="OchiCell width100">
                                                                    <input type="text" id="ov11" class="inputex width100" disabled>
                                                                </div>
                                                            </div>
                                                            <!-- OchiHalf -->
                                                        </div>
    ...
    <div id="messageblockConfirm" class="magpopup magSizeM mfp-hide">
        <div class="magpopupTitle">本年度資料確認</div>
        <div class="padding10ALL">
            <br />
            <div class="OchiTrasTable width100 TitleLength08 font-size3">
                <div class="OchiRow">
            ...
            <div class="margin35T padding5RL">
                <div class="OchiTrasTable width100 TitleLength04 font-size3">
                    <div class="OchiRow">
                        ...
                        <div class="OchiCell width100">
                            <input type="text" class="inputex Jdatepicker width100">
                        </div>
                    </div>
                    <!-- OchiRow -->
                    <div class="OchiRow">
    ...
    <!-- 系統共用 JS -->
    <script type="text/javascript" src="../js/SubMenuGasA.js"></script>
    <!-- 內頁選單 -->
