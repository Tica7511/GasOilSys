<%@ Page Language="C#" AutoEventWireup="true" CodeFile="edit_GasInsideInspect.aspx.cs" Inherits="WebPage_edit_GasInsideInspect" %>
	...
	<script type="text/javascript">
        $(document).ready(function () {
            ...
            $(document).on("click", "#cancelbtn", function () {
                ...
                if (str)
                    location.href = "GasInsideInspect.aspx?cp=" + $.getQueryString("cp");
            });
            ...
            $(document).on("click", "#subbtn", function () {
                ...
                $.ajax({
                    ...
                    url: "../handler/AddGasInsideInspect.aspx",
                    data: data,
                    processData: false,
                    contentType: false,
                    cache: false,
            ...
            $(document).on("click", "a[name='delbtn']", function () {
                ...
                if (isDel) {
                    $.ajax({
                        type: "POST",
                        async: false, //在沒有返回值之前,不會執行下一步動作
                        url: "../Handler/DelGasPipeInspect.aspx",
                        data: {
                            guid: $(this).attr("aid"),
                        },
                        error: function (xhr) {
                            ...
                            $(data).find("data_item").each(function (i) {
                                ...
                                if ($(this).children("佐證資料檔名").text().trim() != '') {
                                    ...
                                    if (extension == '.jpg' || extension == '.jpeg' || extension == '.png' || extension == '.gif') {
                                        filestr += '<img width="300px" height="300px" name="imgfile" src="../DOWNLOAD.aspx?category=Gas&type=pipeinspect&v=' +
                                        ...
                                        filestr += '<a name="afile" href="../DOWNLOAD.aspx?category=Gas&type=pipeinspect&v=' +
