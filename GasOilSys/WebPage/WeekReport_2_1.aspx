<%@ Page Title="" Language="C#" MasterPageFile="~/WebPage/MasterPageWeek.master" AutoEventWireup="true" CodeFile="WeekReport_2_1.aspx.cs" Inherits="WebPage_WeekReport_2_1" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $(document).on("click", "#subbtn", function () {
                ...
                $.ajax({
			    	...
			    	url: "../Handler/AddWeekReport_2_1.aspx",
			    	data: {
			    		mode: mode,
			    		rid: $("#HGuid").val(),
			    	...
			    	success: function (data) {
			    		if ($(data).find("Error").length > 0) {
                            ...
                            location.href = "WeekReport_2_1.aspx?rid=" + $("#RGuid").val() + "&rpid=" + $("#RPGuid").val() + "&year=" + $.getQueryString("year");
			    		}
			    	}
			    });
            });
            ...
            $(document).on("click", "a[name='delbtn']", function () {
                ...
                if (str) {
                    $.ajax({
			        	type: "POST",
			        	async: false, //在沒有返回值之前,不會執行下一步動作
			        	url: "../Handler/DelWeekReport_2_1.aspx",
			        	data: {
			        		rid: $(this).attr("aid"),
			        	},
			        	error: function (xhr) {
        ...
        function getData() {
			$.ajax({
				type: "POST",
				async: false, //在沒有返回值之前,不會執行下一步動作
				url: "../Handler/GetWeekReport_2_1.aspx",
				data: {
