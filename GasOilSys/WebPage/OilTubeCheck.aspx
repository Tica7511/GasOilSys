...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#exportbtn").attr("href", "../Oil_EXPORTEXCEL.aspx?cpid=" + $.getQueryString("cp") + "&year=" + getTaiwanDate() + "&category=tubecheck");

            //選擇年份
            $(document).on("change", "#sellist", function () {
                getData($("#sellist option:selected").val());
                $("#exportbtn").attr("href", "../Oil_EXPORTEXCEL.aspx?cpid=" + $.getQueryString("cp") + "&year=" + $("#sellist option:selected").val() + "&category=tubecheck");
            });
                            ...
                            <div class="OchiTrasTable width100 TitleLength09 font-size3">
                                ...
                                <div class="OchiRow">
                                    ...
                                    <div class="OchiHalf">
                                        ...
                                        <div class="OchiCell width100">
                                            員工 <input type="text" id="checkPerson" class="inputex width20" disabled> 人;
                                            外包 <input type="text" id="checkPersonOutSider" class="inputex width20" disabled> 人
                                        </div>
                                    </div><!-- OchiHalf -->
                                </div><!-- OchiRow -->
                                <div class="OchiRow">
