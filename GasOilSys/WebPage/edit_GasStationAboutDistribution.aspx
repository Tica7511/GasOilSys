<%@ Page Language="C#" AutoEventWireup="true" CodeFile="edit_GasStationAboutDistribution.aspx.cs" Inherits="WebPage_edit_GasStationAboutDistribution" %>
    ...
    <script type="text/javascript">
            ...
            file_browser_callback: function (field_name, url, type, win) {
                if (type == "image") {
                    ...
                    tinymce.activeEditor.windowManager.open({
                        title: "圖片上傳",
                        url: '../../tinymce/ImageUpload/upload.aspx?category=Gas_Upload&type=station&cpName=' + $("#companyName").text() + '&cpguid=' + $.getQueryString("cp"),
                        width: 380,
                        height: 140
                    });
                }
        ...
        $(document).ready(function () {
            ...
            $(document).on("click", "#cancelbtn", function () {
                ...
                if (str)
                    location.href = "GasStationAboutDistribution.aspx?cp=" + $.getQueryString("cp");
            });
            ...
            $(document).on("click", "#subbtn", function () {
                ...
                $.ajax({
                    ...
                    url: "../handler/AddGasStationAboutDistribution.aspx",
                    data: data,
                    processData: false,
                    contentType: false,
                    cache: false,
        ...
        function getData() {
			...
			$.ajax({
				type: "POST",
				async: false, //在沒有返回值之前,不會執行下一步動作
                url: "../Handler/GetGasStationAboutDistribution.aspx",
				data: {
