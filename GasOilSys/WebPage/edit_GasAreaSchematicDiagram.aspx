<%@ Page Language="C#" AutoEventWireup="true" CodeFile="edit_GasAreaSchematicDiagram.aspx.cs" Inherits="WebPage_edit_GasAreaSchematicDiagram" %>
    ...
    <script type="text/javascript">
            ...
            file_browser_callback: function (field_name, url, type, win) {
                if (type == "image") {
                    ...
                    tinymce.activeEditor.windowManager.open({
                        title: "圖片上傳",
                        url: '../../tinymce/ImageUpload/upload.aspx?category=Gas_Upload&type=arealongpipeline&cpName=' + $("#companyName").text() + '&cpguid=' + $.getQueryString("cp"),
                        width: 380,
                        height: 140
                    });
                }
        ...
        $(document).ready(function () {
            ...
            $(document).on("click", "#cancelbtn", function () {
                ...
                if (str)
                    location.href = "GasAreaSchematicDiagram.aspx?cp=" + $.getQueryString("cp");
            });
            ...
            $(document).on("click", "#subbtn", function () {
                ...
                $.ajax({
                    ...
                    url: "../handler/AddGasAreaSchematicDiagram.aspx",
                    data: data,
                    processData: false,
                    contentType: false,
                    cache: false,
