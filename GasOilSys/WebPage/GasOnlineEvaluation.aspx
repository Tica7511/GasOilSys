<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GasOnlineEvaluation.aspx.cs" Inherits="WebPage_GasOnlineEvaluation" %>
...
<head>
	...
	<script type="text/javascript">
        $(document).ready(function () {
            ...
            $(document).on("click", "input[name='delbtn']", function () {
                ...
                if (isDel) {
                    $.ajax({
				        ...
				        url: "../Handler/DelGasOnlineEvaluation.aspx",
                        data: {
                            rid : $(this).attr("aid"),
                        },
				        error: function (xhr) {
            ...
            $(document).on("click", "#savebtn5", function () {
                var msg = '';
