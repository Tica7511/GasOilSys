...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#exportbtn").attr("href", "../Oil_EXPORTEXCEL.aspx?cpid=" + $.getQueryString("cp") + "&year=" + getTaiwanDate() + "&category=storagetankBWT");

            //選擇年份
            $(document).on("change", "#sellist", function () {
                getData($("#sellist option:selected").val());
                $("#exportbtn").attr("href", "../Oil_EXPORTEXCEL.aspx?cpid=" + $.getQueryString("cp") + "&year=" + $("#sellist option:selected").val() + "&category=storagetankBWT");
            });
                    ...
                    <div class="row margin20T">
                        ...
                        <div class="col-lg-9 col-md-8 col-sm-7">
                            ...
                            <div class="margin5TB font-size2">
                                填表說明：<br />
                                (1) 基礎與底板間是否具防水包覆層設計：請填寫「有」或「無」。<br>
                                (2) 接地電阻：依實際定期量測結果，請填寫「有」或「無」。<br>
                                (3) 壁板外部嚴重腐蝕或點蝕：請填寫「有」或「無」。<br>
                                (4) 第一層壁板內部下方腐蝕：請填寫「有」或「無」。<br>
      ...
      <div class="OchiTrasTable width100 TitleLength08 font-size3">
          <div class="OchiRow">
              ...
              <div class="OchiCell width100">
                  <i class="fa fa-file-excel-o IconCc" aria-hidden="true"></i><a href="../doc/import/Oil/石油_儲槽基礎、壁板、頂板.xls">下載</a>
              </div>
          </div><!-- OchiRow -->
          <div class="OchiRow">
