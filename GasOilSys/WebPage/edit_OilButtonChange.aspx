<%@ Page Language="C#" AutoEventWireup="true" CodeFile="edit_OilButtonChange.aspx.cs" Inherits="WebPage_edit_OilButtonChange" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $(document).on("click", "#cancelbtn", function () {
                ...
                if (str)
                    location.href = "OilButtonChange.aspx?cp=" + $.getQueryString("cp");
            });
            ...
            $(document).on("click", "#subbtn", function () {
                ...
                $.ajax({
                    ...
                    url: "../handler/AddOilButtonChange.aspx",
                    data: data,
                    processData: false,
                    contentType: false,
                    cache: false,
					...
					if ($(data).find("Error").length > 0) {
						...
						if ($(data).find("data_item").length > 0) {
                            $(data).find("data_item").each(function (i) {
                                ...
                                $("#txt2").val(getDate($(this).children("更換日期").text().trim()));
                                $("#txt3").val($(this).children("更換面積").text().trim());
                                $("#txt4").val($(this).children("更換原因").text().trim());
							});
						}
					}
				}
                    ...
                    <div class="row margin20T">
                        ...
                        <div class="col-lg-9 col-md-8 col-sm-7">
                            ...
                            <div class="OchiTrasTable width100 TitleLength09 font-size3">
                                <div class="OchiRow">
                                    <div class="OchiHalf">
                                        <div class="OchiCell OchiTitle IconCe TitleSetWidth">更換日期</div>
                                        <div class="OchiCell width100"><input type="text" id="txt2" class="inputex width40 pickDate" disabled></div>
                                    </div><!-- OchiHalf -->
                                    <div class="OchiHalf">
                                        <div class="OchiCell OchiTitle IconCe TitleSetWidth">更換面積</div>
                                        <div class="OchiCell width100"><input type="text" id="txt3" class="inputex width80"> m²</div>
                                    </div><!-- OchiHalf -->
                                </div><!-- OchiRow -->
                                <div class="OchiRow">
                                    <div class="OchiCell OchiTitle IconCe TitleSetWidth">更換原因</div>
