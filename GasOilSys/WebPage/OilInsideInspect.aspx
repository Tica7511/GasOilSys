<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OilInsideInspect.aspx.cs" Inherits="WebPage_OilInsideInspect" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $(document).on("click", "#newbtn", function () {
                location.href = "edit_OilInsideInspect.aspx?cp=" + $.getQueryString("cp");
            });
					...
					if ($(data).find("Error").length > 0) {
						...
						if ($(data).find("data_item").length > 0) {
                            $(data).find("data_item").each(function (i) {
                                ...
                                tabstr += '<a name="a_' + $(this).children("guid").text().trim() + '" href="../DOWNLOAD.aspx?category=Oil&type=pipeinspect&v=' + $(this).children("guid").text().trim() +
                                ...
                                tabstr += ' <a href="edit_OilInsideInspect.aspx?cp=' + $.getQueryString("cp") + '&guid=' + $(this).children("guid").text().trim() + '" name="editbtn">編輯</a></td>';
								tabstr += '</tr>';
							});
						}
						else
