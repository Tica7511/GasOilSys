<%@ Page Language="C#" AutoEventWireup="true" CodeFile="edit_GasAccidentLearning.aspx.cs" Inherits="WebPage_edit_GasAccidentLearning" %>
	...
	<script type="text/javascript">
        $(document).ready(function () {
            ...
            $(document).on("click", "#cancelbtn", function () {
                ...
                if (str)
                    location.href = "GasAccidentLearning.aspx?cp=" + $.getQueryString("cp");
            });
            ...
            $(document).on("click", "#subbtn", function () {
                ...
                $.ajax({
                    ...
                    url: "../handler/AddGasAccidentLearning.aspx",
                    data: data,
                    processData: false,
                    contentType: false,
                    cache: false,
                    ...
                    if ($(data).find("Error").length > 0) {
                        ...
                        if ($(data).find("data_item").length > 0) {
                            $(data).find("data_item").each(function (i) {
                                $("#txt1").val(getDate($(this).children("事故日期").text().trim()));
                                $("#txt2").val($(this).children("事故名稱").text().trim());
                                $("#txt3").val($(this).children("事故原因").text().trim());
                                $("#txt4").val($(this).children("改善作為").text().trim());
                            });
                        }
                    }
                }
                    ...
                    <div class="row margin20T">
						...
						<div class="col-lg-9 col-md-8 col-sm-7">
                            ...
                            <div class="OchiTrasTable width100 TitleLength09 font-size3">
                                <div class="OchiRow">
                                    <div class="OchiHalf">
                                        <div class="OchiCell OchiTitle IconCe TitleSetWidth">事故日期</div>
                                        <div class="OchiCell width100"><input type="text" id="txt1" class="inputex width40 pickDate" disabled></div>
                                    </div><!-- OchiHalf -->
                                    <div class="OchiHalf">
                                        <div class="OchiCell OchiTitle IconCe TitleSetWidth">事故名稱</div>
                                        <div class="OchiCell width100"><input type="text" id="txt2" class="inputex width100"></div>
                                    </div><!-- OchiHalf -->
                                </div><!-- OchiRow -->
                                <div class="OchiRow">
                                    <div class="OchiCell OchiTitle IconCe TitleSetWidth">事故原因</div>
                                    <div class="OchiCell width100"><textarea id="txt3" rows="5" cols="" class="inputex width100" ></textarea></div>
                                </div><!-- OchiRow -->
                                <div class="OchiRow">
                                    <div class="OchiCell OchiTitle IconCe TitleSetWidth">改善作為</div>
                                    <div class="OchiCell width100"><textarea id="txt4" rows="5" cols="" class="inputex width100" ></textarea></div>
                                </div><!-- OchiRow -->
                            </div><!-- OchiTrasTable -->
                        </div><!-- col -->
                    </div><!-- row -->
