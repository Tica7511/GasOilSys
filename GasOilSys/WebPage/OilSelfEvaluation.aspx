                        ...
                        if ($(data).find("data_item").length > 0) {
                            $(data).find("data_item").each(function (i) {
                                ...
                                switch ($(this).children("單位屬性").text().trim()) {
                                    case "01":
                                        str += '<i class="fa fa-file-word-o IconCc" aria-hidden="true"></i><a href="../doc/113_Bread/Oil/管線儲槽(有委員)/113年石油業者查核填寫內容下載(管線儲槽有委員).docx" target="_blank">查核填寫內容下載</a> ' +
                                            ...
                                            '<i class="fa fa-file-powerpoint-o IconCc" aria-hidden="true"></i><a href="../doc/113_Bread/Oil/管線儲槽(有委員)/113年石油業者簡報大綱下載(管線儲槽有委員).pptx" target="_blank">簡報大綱下載</a> ' +
                                            '<i class="fa fa-file-pdf-o IconCc" aria-hidden="true"></i><a href="../doc/113_Bread/Oil/管線儲槽(有委員)/113年石油業者應準備資料下載(管線儲槽有委員).docx" target="_blank">應準備資料下載</a> ';
                                        break;
                                    case "02":
                                        str += '<i class="fa fa-file-word-o IconCc" aria-hidden="true"></i><a href="../doc/113_Bread/Oil/管線儲槽(無委員)/113年石油業者查核填寫內容下載(管線儲槽無委員).docx" target="_blank">查核填寫內容下載</a> ' +
                                            '<i class="fa fa-file-pdf-o IconCc" aria-hidden="true"></i><a href="../doc/113_Bread/Oil/113年石油業者查核配合事項下載.pdf" target="_blank">查核配合事項下載</a> ' +
                                            '<i class="fa fa-file-powerpoint-o IconCc" aria-hidden="true"></i><a href="../doc/113_Bread/Oil/管線儲槽(無委員)/113年石油業者簡報大綱下載(管線儲槽無委員).pptx" target="_blank">簡報大綱下載</a> ' +
                                            '<i class="fa fa-file-pdf-o IconCc" aria-hidden="true"></i><a href="../doc/113_Bread/Oil/管線儲槽(無委員)/113年石油業者應準備資料下載(管線儲槽無委員).docx" target="_blank">應準備資料下載</a> ';
                                        break;
                                    case "03":
                                    ...
                                    case "04":
                                        str += '<i class="fa fa-file-word-o IconCc" aria-hidden="true"></i><a href="../doc/113_Bread/Oil/儲槽(無委員)/113年石油業者查核填寫內容下載(儲槽無委員).docx" target="_blank">查核填寫內容下載</a> ' +
                                            '<i class="fa fa-file-pdf-o IconCc" aria-hidden="true"></i><a href="../doc/113_Bread/Oil/113年石油業者查核配合事項下載.pdf" target="_blank">查核配合事項下載</a> ' +
                                            '<i class="fa fa-file-powerpoint-o IconCc" aria-hidden="true"></i><a href="../doc/113_Bread/Oil/儲槽(無委員)/113年石油業者簡報大綱下載(儲槽無委員).pptx" target="_blank">簡報大綱下載</a> ' +
                                            '<i class="fa fa-file-pdf-o IconCc" aria-hidden="true"></i><a href="../doc/113_Bread/Oil/儲槽(無委員)/113年石油業者應準備資料下載(儲槽無委員).docx" target="_blank">應準備資料下載</a> ';
                                        break;
                                    case "05":
