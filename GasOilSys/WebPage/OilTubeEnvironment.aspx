<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OilTubeEnvironment.aspx.cs" Inherits="WebPage_OilTubeEnvironment" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $(document).on("click", "#newbtn", function () {
                location.href = "edit_OilTubeEnvironment.aspx?cp=" + $.getQueryString("cp");
            });
            ...
            $(document).on("click", "a[name='delbtn']", function () {
                if (confirm("確定刪除?")) {
                    $.ajax({
                        ...
                        url: "../handler/DelOilTubeEnvironment.aspx",
                        data: {
                            guid: $(this).attr("aid"),
                        },
                        error: function (xhr) {
					...
					if ($(data).find("Error").length > 0) {
						...
						if ($(data).find("data_item").length > 0) {
							$(data).find("data_item").each(function (i) {
								...
								tabstr += '<td nowrap="nowrap">' + $(this).children("其他").text().trim() + '</td>';
                                ...
                                tabstr += ' <a href="edit_OilTubeEnvironment.aspx?cp=' + $.getQueryString("cp") + '&guid=' + $(this).children("guid").text().trim() + '" name="editbtn">編輯</a></td>';
                                tabstr += '</tr>';
							});
						}
						else
