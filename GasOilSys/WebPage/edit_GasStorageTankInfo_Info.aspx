<%@ Page Language="C#" AutoEventWireup="true" CodeFile="edit_GasStorageTankInfo_Info.aspx.cs" Inherits="WebPage_edit_GasStorageTankInfo_Info" %>
        ...
        $(document).ready(function () {
            ...
            $(document).on("click", "#subbtn", function () {
                ...
                $.ajax({
                    ...
                    url: "../handler/AddGasStorageTankInfoInfo.aspx",
                    data: data,
                    processData: false,
                    contentType: false,
                    cache: false,
                    ...
                    if ($(data).find("Error").length > 0) {
                        ...
                        if ($(data).find("data_item").length > 0) {
                            $(data).find("data_item").each(function (i) {
                                $("#txt1").val($(this).children("液化天然氣廠").text().trim());
                                $("#txt2").val($(this).children("儲槽編號").text().trim());
                                $("#txt3").val($(this).children("容量").text().trim());
                                $("#txt4").val($(this).children("外徑").text().trim());
                                $("#txt5").val($(this).children("高度").text().trim());
                                $("#txt6").val($(this).children("形式").text().trim());
                                $("#txt7").val(getDate($(this).children("啟用日期").text().trim()));
                                $("#txt8").val($(this).children("狀態").text().trim());
                                $("#txt9").val($(this).children("勞動部檢查").text().trim());
                                $("#txt10").val($(this).children("代行檢查機構").text().trim());
                            });
                        }
                    }
                }
                            ...
                            <div class="OchiTrasTable width100 TitleLength09 font-size3">
                                ...
                                <div class="OchiRow">
                                    <div class="OchiHalf">
                                        ...
                                        <div class="OchiCell width100"><input type="text" id="txt7" class="inputex width40 pickDate" disabled></div>
                                    </div><!-- OchiHalf -->
                                    <div class="OchiHalf">
                                ...
                                <div class="OchiRow">
                                    <div class="OchiHalf">
                                        <div class="OchiCell OchiTitle IconCe TitleSetWidth">勞動部檢查合格證及有效期限</div>
                                        <div class="OchiCell width100"><input type="text" id="txt9" class="inputex width100"></div>
                                    </div><!-- OchiHalf -->
                                    <div class="OchiHalf">
                                        <div class="OchiCell OchiTitle IconCe TitleSetWidth">代行/檢查機構</div>
